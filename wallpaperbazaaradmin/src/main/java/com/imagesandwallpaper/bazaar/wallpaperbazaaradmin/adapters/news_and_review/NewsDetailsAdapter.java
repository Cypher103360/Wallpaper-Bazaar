...
public class NewsDetailsAdapter extends RecyclerView.Adapter<NewsDetailsAdapter.ViewHolder> {
    ...
    Context context;
    NewsDetailsClickInterface detailsClickInterface;

    public NewsDetailsAdapter(Context context, NewsDetailsClickInterface detailsClickInterface) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        Glide.with(context).load("https://gedgetsworld.in/Wallpaper_Bazaar/fs_news_details_img/" +
                detailsModelList.get(position).getNewsImg()).into(holder.newsImg);
        holder.itemView.setOnClickListener(view -> detailsClickInterface.OnNewsClicked(detailsModelList.get(position)));
