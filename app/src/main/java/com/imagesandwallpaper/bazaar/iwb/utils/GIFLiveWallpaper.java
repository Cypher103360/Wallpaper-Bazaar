...
public class GIFLiveWallpaper extends WallpaperService {
    ...
    private class GIFWallpaperEngine extends Engine {
        ...
        public void onSurfaceCreated(SurfaceHolder holder) {
            ...
            Log.d("contentValue", FullscreenActivity.gifName + " " + FullscreenActivity.gifName);
            ...
            try {
                ...
                if (FullscreenActivity.gifName == null) {
                    ...
                    File imageFile = new File(FullscreenActivity.gifPath, FullscreenActivity.gifName);
                    final int readLimit = 16 * 1024;
                    {
